...
//     const [email, setEmail] = useState('');
//     const [search, setSearch] = useState("");
//     const [isSearchVisible, setIsSearchVisible] = useState(false); // State for search box visibility
...
//                     <>
//                         <form
//                             className={`form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search ${isSearchVisible ? '' : 'd-none d-sm-inline-block'}`}>
//                             <div className="input-group">
//                                 <input type="text" className="form-control bg-light border-0 small"
//                                     value={search}
//                                     onChange={(e) => setSearch(e.target.value)}
...
//                     <li className="nav-item dropdown no-arrow d-sm-none">
//                         <a className="nav-link dropdown-toggle" href="0" id="searchDropdown" role="button"
//                             data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" onClick={toggleSearch}>
//                             <i className="fas fa-search fa-fw"></i>
//                         </a>
//                         {/* <!-- Dropdown - Messages --> */}
//                         {isSearchVisible && (
...
//                                 src="img/undraw_profile.svg" alt="img" />
//                             <div style={{ textAlign: 'left' }}>
//                                 <span className="mr-2 d-none d-lg-inline text-gray-600 small">{name} {surname} <br /> {email}</span>
//                             </div>
//                         </a>
//                     </li>
                ...
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item dropdown no-arrow d-sm-none">
                        <button className="nav-link dropdown-toggle" type="button"
                            id="searchDropdown" onClick={toggleSearch}>
                            <i className="fas fa-search fa-fw"></i>
                        </button>
                        {/* <!-- Dropdown - Messages --> */}
                        {isSearchVisible && (
